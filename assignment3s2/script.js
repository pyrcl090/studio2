...
function showFrames() {
    ...
    //  let frameSpeak = frame.fields.web;
    //  frameSpeak.forEach(function(web){
    //  frameContainer.classList.add(web)
    //  })
    //   let filterSpeak = document.querySelector('.speak');
    //   filterSpeak.addEventListener("click",function(){

    //     if(frameContainer.classList.contains("yes")){
