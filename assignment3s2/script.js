...
//     var picture = frame.fields.web;
//     picture.forEach(function(web) {
//       frameContainer.classList.add(web);
//     });

//     var display = document.querySelector(".onOrOff");
//     display.addEventListener("click", function() {
//       if (songContainer.classList.contains("yes")) {
...
// on click function that hides all other information, except for items being clicked.

// filter by two categories, on click allow to view two categories at once